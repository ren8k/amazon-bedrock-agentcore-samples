...
Recent Interests: blockchain technology, NFTs, metaverse"""
    ...
    try:
        ...
        if "response" in response:
            ...
            print(
                "📋 Follow-up question: 'It's Maria Rodriguez, What's the latest news on cryptocurrency and fintech stocks?'"
            )
            print("\n" + "=" * 50)
            ...
            if "response" in response2:
                ...
                if found_indicators:
                    ...
                    print(
                        f"   Found personalization indicators: {', '.join(found_indicators)}"
                    )
                else:
                ...
                print(
                    "This shows how users should interact with the Market Trends Agent:"
                )
